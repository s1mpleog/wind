...
WIND_NODISCARD auto FUGpuAllocator::CreateVkImage(uint32 Width, uint32 Height, EFormat Format,
...
WIND_NODISCARD auto FUGpuAllocator::CreateDepthBuffer(const FVulkanContext *Context, uint32 Width,
                                                     uint32 Height) WIND_NOEXCEPT -> TWindResult<FAllocatedImage>
{
	auto [image, image_allocation] =
...
WIND_NODISCARD auto FUGpuAllocator::CreateDynamicBuffer(uint32 Size, vk::BufferUsageFlagBits Usage) WIND_NOEXCEPT
    -> TWindResult<FAllocatedBuffer>
{
	vk::BufferCreateInfo BufferInfo{};
