...
// #include "Config.hpp"
// #include "Vulkan/Core/Public/Configuration.hpp"
...
// constexpr auto ToVk(EVulkanVersion Value) noexcept -> uint32_t
// {
// 	switch (Value)
// 	{
...
constexpr auto ToVk(EDebugMessageSeverity Value) noexcept -> vk::DebugUtilsMessageSeverityFlagBitsEXT
{
	return static_cast<vk::DebugUtilsMessageSeverityFlagBitsEXT>(static_cast<uint32_t>(Value));
}

constexpr auto ToVk(EDebugMessageType Value) noexcept -> vk::DebugUtilsMessageTypeFlagsEXT
{
	return static_cast<vk::DebugUtilsMessageTypeFlagsEXT>(static_cast<uint32_t>(Value));
}

// auto ToVk(EPrimitiveTopology Topology) noexcept -> vk::PrimitiveTopology;
// auto ToVk(ECullMode CullMode) noexcept -> vk::CullModeFlagBits;
// auto ToVk(EPolygonMode PolygonMode) noexcept -> vk::PolygonMode;
// auto ToVk(EFrontFace FrontFace) noexcept -> vk::FrontFace;
// auto ToVk(EFormat Format) noexcept -> vk::Format;
// auto ToVk(EVertexFormat Format) noexcept -> vk::Format;
// auto ToVk(EVertexInputRate InputRate) noexcept -> vk::VertexInputRate;
// auto ToVk(ECompareOp CompareOp) noexcept -> vk::CompareOp;
// auto ToVk(EShaderStage Stage) noexcept -> vk::ShaderStageFlagBits;
// auto ToVk(const FVertexAttribute &Attribute) noexcept -> vk::VertexInputAttributeDescription;
// auto ToVk(const FVertexBinding &Binding) noexcept -> vk::VertexInputBindingDescription;
// auto ToVk(const FVertexInputState &VertexInput)noexcept
//     -> std::pair<std::vector<vk::VertexInputAttributeDescription>, std::vector<vk::VertexInputBindingDescription>>;
// auto ToVk(const FRasterizationState &Rasterization) noexcept -> vk::PipelineRasterizationStateCreateInfo;
// auto ToVk(const FInputAssemblyState &InputAssembly) noexcept -> vk::PipelineInputAssemblyStateCreateInfo;
// auto ToVk(const FDepthStencilState &DepthStencil) noexcept -> vk::PipelineDepthStencilStateCreateInfo;
// auto ToVk(EBlendFactor BlendFactor) noexcept -> vk::BlendFactor;
// auto ToVk(EBlendOp BlendOp) noexcept -> vk::BlendOp;
// auto ToVk(const FColorBlendState &ColorBlend) noexcept -> vk::PipelineColorBlendAttachmentState;

// // Implementation

// WIND_INLINE auto ToVk(EPrimitiveTopology Topology) noexcept -> vk::PrimitiveTopology
// {
// 	switch (Topology)
// 	{
...
// WIND_INLINE auto ToVk(ECullMode CullMode) noexcept -> vk::CullModeFlagBits
// {
// 	switch (CullMode)
// 	{
// 	case ECullMode::Back:
...
// WIND_INLINE auto ToVk(EPolygonMode PolygonMode) noexcept -> vk::PolygonMode
// {
// 	switch (PolygonMode)
// 	{
...
// WIND_INLINE auto ToVk(EFrontFace FrontFace) noexcept -> vk::FrontFace
// {
// 	switch (FrontFace)
// 	{
...
// WIND_INLINE auto ToVk(EFormat Format) noexcept -> vk::Format
// {
// 	switch (Format)
// 	{
...
// WIND_INLINE auto ToVk(EVertexFormat Format) noexcept -> vk::Format
// {
// 	switch (Format)
// 	{
...
// WIND_INLINE auto ToVk(EVertexInputRate InputRate) noexcept -> vk::VertexInputRate
// {
// 	switch (InputRate)
// 	{
...
// WIND_INLINE auto ToVk(const FVertexAttribute &Attribute) noexcept -> vk::VertexInputAttributeDescription
// {
// 	return vk::VertexInputAttributeDescription{Attribute.Location, Attribute.Binding, ToVk(Attribute.Format),
// 	                                           Attribute.Offset};
// }

// WIND_INLINE auto ToVk(std::span<const FVertexAttribute> Attributes)noexcept
...
// WIND_INLINE auto ToVk(const FVertexBinding &Binding) noexcept -> vk::VertexInputBindingDescription
// {
// 	return vk::VertexInputBindingDescription{Binding.Binding, Binding.Stride, ToVk(Binding.InputRate)};
// }

// WIND_INLINE auto ToVk(std::span<const FVertexBinding> Bindings)noexcept
...
// WIND_INLINE auto ToVk(const FVertexInputState &VertexInput)noexcept
//     -> std::pair<std::vector<vk::VertexInputAttributeDescription>, std::vector<vk::VertexInputBindingDescription>>
// {
...
// WIND_INLINE auto ToVk(ECompareOp CompareOp) noexcept -> vk::CompareOp
// {
// 	switch (CompareOp)
// 	{
...
// WIND_INLINE auto ToVk(EShaderStage Stage) noexcept -> vk::ShaderStageFlagBits
// {
// 	switch (Stage)
// 	{
...
// WIND_INLINE auto ToVkShaderStageFlags(EShaderStage Stages) noexcept -> vk::ShaderStageFlags
// {
...
// WIND_INLINE auto ToVk(const FRasterizationState &Rasterization)noexcept
...
// WIND_INLINE auto ToVk(const FInputAssemblyState &InputAssembly)noexcept
...
// WIND_INLINE auto ToVk(const FDepthStencilState &DepthStencil) noexcept -> vk::PipelineDepthStencilStateCreateInfo
// {
...
// WIND_INLINE auto ToVk(EBlendFactor BlendFactor) noexcept -> vk::BlendFactor
// {
// 	switch (BlendFactor)
// 	{
...
// WIND_INLINE auto ToVk(EBlendOp BlendOp) noexcept -> vk::BlendOp
// {
// 	switch (BlendOp)
// 	{
// 	case EBlendOp::Add:
...
// WIND_INLINE auto ToVk(const FPushConstantRange &PushConstant) noexcept -> vk::PushConstantRange
// {
...
// WIND_INLINE auto ToVk(const FColorBlendState &ColorBlend) noexcept -> vk::PipelineColorBlendAttachmentState
// {
...
// WIND_INLINE auto ToVk(const FGraphicsConfig &Config) noexcept -> FPipelineCreateInfo
// {
