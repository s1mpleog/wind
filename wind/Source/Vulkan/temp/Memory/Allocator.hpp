...
class FUGpuAllocator
{
  public:
	...
	WIND_NODISCARD auto CreateDepthBuffer(const FVulkanContext *Context, uint32 Width, uint32 Height) WIND_NOEXCEPT
  ...
  private:
	...
	WIND_NODISCARD auto CreateVkImage(uint32 Width, uint32 Height, EFormat Format,
